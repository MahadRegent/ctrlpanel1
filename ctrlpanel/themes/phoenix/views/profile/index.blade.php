    ...
    <div class="ease-soft-in-out xl:ml-68.5 relative transition-all duration-200 text-gray-700 dark:text-gray-200">
      ...
      <div class="w-full mx-auto">
        <div class="relative flex items-center p-0 mt-6 overflow-hidden bg-center bg-cover min-h-75 rounded-2xl"
          ...
          <span
            class="absolute inset-y-0 w-full h-full bg-center bg-cover bg-gradient-to-tl from-primary-700 to-pink-500 opacity-60"></span>
        </div>
        <div
                ...
                <ul class="relative flex flex-wrap p-1 list-none bg-transparent rounded-xl flex-col on-resize"
                  ...
                  <li class="z-30 flex-auto text-center">
                    <span
                      ...
                      {{ $user->Credits() }} {{ $general_settings->credits_display_name }}
                    </span>
                  </li>
                  <li class="z-30 flex-auto text-center">
      ...
      <div class="w-full py-6 mx-auto">
        <div class="grid gap-6 mb-8 md:grid-cols-2">
          <div
            ...
            <x-button class="m-4 mt-2 bg-red-500 hover:bg-red-600 text-white sm:w-1/3" id="confirmDeleteButton"
                      ...
                      <div class="tab-content">
                        ...
                        <div class="row">
                          <div class="col d-flex justify-content-end">
                            ...
                            <button
                              class="px-4 py-2 text-sm font-medium leading-5 text-white transition-colors duration-150 bg-primary-600 border border-transparent rounded-lg active:bg-primary-600 hover:bg-primary-700 focus:outline-none focus:shadow-outline-purple"
