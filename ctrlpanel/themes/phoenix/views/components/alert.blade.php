...
@php
  switch ($type) {
      ...
      case 'info':
      default:
          $color_scheme = 'text-primary-700 bg-primary-100 dark:bg-primary-500/20 dark:text-primary-500';
          $sr_text = 'Information';
          break;
      case 'warning':
...
<div
  {{ $attributes->class([$class, 'flex p-4 my-6 text-sm rounded-lg', $color_scheme, 'mt-0' => !str_contains($class, 'mt-')]) }}
  role="alert">
