          ...
          <div class="flex flex-wrap -mx-3">
            ...
            <div class="flex-none w-auto max-w-full px-3 my-auto">
              <div class="h-full">
                ...
                <p class="mb-0 font-semibold leading-normal text-sm">{{ $user->email }}
                ...
                @if ($user->referredBy())
                  <p>{{ __('Referred by') }}: <a class="underline text-primary-500"
            ...
            <tr class="text-gray-700 dark:text-gray-300">
              ...
              <td class="px-4 py-3 text-sm">
                <a href="{{ route('admin.users.show', $referral->id) }}"
                  class="underline text-primary-600">{{ $referral->name }}</a>
              </td>
              <td class="px-4 py-3 text-sm">
