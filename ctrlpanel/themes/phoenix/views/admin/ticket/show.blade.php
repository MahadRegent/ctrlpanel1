          ...
          <div class="flex gap-4 flex-col">
            <div
              ...
              <div
                ...
                <span class="badge badge-primary"> <x-tooltip :content="$ticket->created_at->isoFormat('LLL')" pos="bottom" class="">
                    {{ $ticket->created_at->diffForHumans() }}
                  </x-tooltip>
                </span>
            ...
            @foreach ($ticketcomments as $ticketcomment)
              <div
                ...
                <div
                  ...
                  <span class="badge badge-primary"> <x-tooltip :content="$ticketcomment->created_at->isoFormat('LLL')" pos="bottom" class="">
            ...
            <div class="comment-form">
              <form action="{{ route('admin.ticket.reply') }}" method="POST" class="form reply-form">
                {!! csrf_field() !!}
